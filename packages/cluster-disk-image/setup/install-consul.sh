...
function fetch_binary {
  ...
  if [[ -z "$download_url" && -n "$version" ]];  then
    download_url="https://releases.hashicorp.com/consul/${version}/consul_${version}_linux_${arch_suffix}.zip"
  fi

  log_info "Downloading Consul for architecture: $arch_suffix from $download_url"
